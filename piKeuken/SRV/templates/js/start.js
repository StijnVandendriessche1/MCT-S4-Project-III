...
let isclicked = false;
let isSettingsClickedCoffee = false;
...
const loadDOM = function () {
    ...
    domCoffee = document.querySelector(".js-settings__coffee-icon");
    domCoffee.addEventListener("click", function () {
        showSettingsCoffee();
    });

    domDishwasher = document.querySelector(".js-settings__dishwasher-icon");
...
const showSettingsCoffee = function () {
    box = document.querySelector(".js-settings__coffee");
    console.log(box);
    if (isSettingsClickedCoffee == false) {
        box.style.display = "block";
        isSettingsClickedCoffee = true;
        console.log("showed");
    } else {
        box.style.display = "none";
        isSettingsClickedCoffee = false;
        console.log("hidden");
    }
};
